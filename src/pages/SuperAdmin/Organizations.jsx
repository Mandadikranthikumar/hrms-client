...
export default function Organizations() {
  ...
  // =====================================================
  // 1. CREATE ORGANIZATION MODAL STATE (Unified with HR)
  // =====================================================
  ...
  // =====================================================
  // HANDLER: Create Organization & HR
  // =====================================================
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      ...
      showToast(
        "success",
        res.message || "Organization and HR created successfully in database"
      );
  ...
  const filteredOrgs = organizations.filter((org) => {
    ...
    const matchesSearch =
      ...
      (org.orgCode || "").toLowerCase().includes(searchLower) ||
      (org.hrName || "").toLowerCase().includes(searchLower) ||
      (org.hrEmail || "").toLowerCase().includes(searchLower);
  ...
  return (
    <div className="orgs-page-container">
      ...
      <div className="orgs-page-header">
        <div>
          <h1>Organizations Hub</h1>
          <p>Supervise organizations, provisioned HR administrators, and enrolled employees.</p>
        </div>
      ...
      <Card>
        <div className="orgs-filter-bar">
          <div className="orgs-search-box">
            <FiSearch className="orgs-search-icon" size={16} />
            <input
              type="text"
              placeholder="Search by organization name, ID, HR name, or HR email..."
              value={search}
        ...
        <Table
          ...
          data={filteredOrgs}
          loading={loading}
          emptyText="No organizations found matching your criteria."
        />
      </Card>
